            ...
            <Container maxWidth="fixed">
                <div className={'root'}>
                    <Grid container spacing={3}>
                        ...
                        <Grid item lg={8} md={7} sm={12} xs={12} className='search-section'>
